        76,3,20,10,0,76,77,7,1,0,0,77,78,3,20,10,0,78,80,1,0,0,0,79,59,1,
        0,0,0,79,65,1,0,0,0,79,71,1,0,0,0,79,75,1,0,0,0,80,13,1,0,0,0,81,
        82,5,10,0,0,82,83,7,2,0,0,83,84,5,11,0,0,84,15,1,0,0,0,85,86,7,3,
        0,0,86,17,1,0,0,0,87,88,7,4,0,0,88,19,1,0,0,0,89,90,6,10,-1,0,90,
        100,3,4,2,0,91,93,3,18,9,0,92,94,3,16,8,0,93,92,1,0,0,0,93,94,1,
        0,0,0,94,100,1,0,0,0,95,96,5,10,0,0,96,97,3,20,10,0,97,98,5,11,0,
        0,98,100,1,0,0,0,99,89,1,0,0,0,99,91,1,0,0,0,99,95,1,0,0,0,100,121,
        1,0,0,0,101,102,10,5,0,0,102,103,7,5,0,0,103,120,3,20,10,6,104,105,
        10,3,0,0,105,106,7,0,0,0,106,120,3,20,10,4,107,108,10,2,0,0,108,
        109,5,3,0,0,109,120,3,20,10,3,110,111,10,1,0,0,111,112,5,4,0,0,112,
        120,3,20,10,2,113,114,10,4,0,0,114,115,5,12,0,0,115,117,3,20,10,
        0,116,118,3,14,7,0,117,116,1,0,0,0,117,118,1,0,0,0,118,120,1,0,0,
        0,119,101,1,0,0,0,119,104,1,0,0,0,119,107,1,0,0,0,119,110,1,0,0,
        0,119,113,1,0,0,0,120,123,1,0,0,0,121,119,1,0,0,0,121,122,1,0,0,
        0,122,21,1,0,0,0,123,121,1,0,0,0,14,25,34,38,47,57,63,69,73,79,93,
        99,117,119,121
    ]
...
class ExprParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "SINGLE_COMMENT", "MULTILINE_COMMENT", 
                      ...
                      "RSQPAREN", "LINEAR", "GAUSSIAN", "DAYS", "WEEKS", 
                      "HOURS", "MINUTES", "INT", "FLOAT", "ID", "BRACKET_ID", 
                      "WS", "NL" ]
    ...
    RULE_basicId = 3
    RULE_sequenceId = 4
    RULE_sequenceIndex = 5
    RULE_stat = 6
    RULE_rangeSpec = 7
    RULE_unit = 8
    RULE_numericLiteral = 9
    RULE_expr = 10

    ruleNames =  [ "program", "terminate", "id", "basicId", "sequenceId", 
                   "sequenceIndex", "stat", "rangeSpec", "unit", "numericLiteral", 
                   "expr" ]
    ...
    def sequenceId(self):
        ...
        self.enterRule(localctx, 8, self.RULE_sequenceId)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 40
    ...
    def sequenceIndex(self):
        ...
        self.enterRule(localctx, 10, self.RULE_sequenceIndex)
        self._la = 0 # Token type
        try:
            self.state = 57
            self._errHandler.sync(self)
    ...
    def rangeSpec(self):
        ...
        self.enterRule(localctx, 14, self.RULE_rangeSpec)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 81
    ...
    def numericLiteral(self):
        ...
        self.enterRule(localctx, 18, self.RULE_numericLiteral)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 87
