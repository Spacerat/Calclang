...
import type { PercentilesOutput } from './PercentilesOutput';
import type { ValueInequalityOutput } from './ValueInequalityOutput';
import type { ValueOutput } from './ValueOutput';

export type Analysis = {
    name: string;
    outputs: Array<(ValueOutput | MeasureOutput | DistributionOutput | ValueInequalityOutput | InequalityProbabilityOutput | PercentilesOutput)>;
};
